		...
		onSubmitHandler(event) {
			...
			fetch(`${routes.cart_add_url}`, config)
				...
				.then((response) => {
                    ...
                    // console.log( this.minicart.querySelector(".free-shipping-progress").dataset.cart_total );
                    // console.log( Shopify.currency.rate * freeShipingPrice );
		...
		handleErrorMessage(errorMessage = false) {
            ...
            */  
            if( document.querySelector(".product-form-error-message") != "undefined" ){
              document.querySelector(".product-form-error-message-wrapper").classList.add("form-status-error");
